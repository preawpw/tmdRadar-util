        ...
        var img1 = Jimp.read(input1, function (err, img1) {
            var img2 = Jimp.read(input2, function (err, img2) { //background image
                var img3 = new Jimp(img2.bitmap.width, img2.bitmap.height, black, function (err, img3) {
                    ...
                    //img3.write(item._id+ ".png");
                    /*---------------------------- การคำนวณปริมาณน้ำฝน ----------------------------------*/
                    var sum = 0;
                    var n = 0;
                    var latitude = 100.72917;//คลองสามวา
                    var longitude = 13.85958;
                    var result;
                    px = Math.round(((latitude - 99.841902) * 1600) / 1.840273);
                    py = Math.round(((14.722223 - longitude) * 1600) / 1.785963);
                    ...
                    txtResult = txtResult + (dt.getTime() / 1000).toString() + "," + (result).toString() + "\n";
